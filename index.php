  ...
  <body>
    <div class="page-wrapper">
      ...
      <main class="main-wrapper">
        ...
        <section data-w-id="12e87c77-aabe-a0b6-d030-78a6c3bd4be5" class="section-track background-color-black">
          <div class="circle-container">
            <div class="page-padding">
              <div class="container-large z-2">
                <h2 id="w-node-_2db962c6-7794-b2d2-0358-156d878f1a09-0a0a72b5" class="heading-xlarge">What i do</h2>
              </div>
            </div>
          ...
          <div class="sticky-section-wrapper">
            <div class="page-padding">
              <div class="container-large">
                <div class="w-layout-grid expertise-component-grid">
                  <div data-w-id="49cbd1f1-7ace-548c-6dd5-f263513395d8" style="opacity:0" class="expertise-content-wrapper _1">
                    <div class="expertise-icon">
                      <div class="circle-icon _1"></div>
                  ...
                  <div data-w-id="9c2337f4-70f5-10d7-0cb1-071bc8c98df7" style="opacity:0" class="expertise-content-wrapper _2">
                    <div class="expertise-icon">
                      <div class="circle-icon _4"></div>
                  ...
                  <div data-w-id="daf041a0-caad-55c5-3021-75ba349cd7e9" style="opacity:0" class="expertise-content-wrapper _3">
                    <div class="expertise-icon">
                      <div class="circle-icon _7"></div>
        ...
        <section class="section-home-works">
          <div class="page-padding">
            <div class="container-large">
              <div class="padding-vertical padding-huge">
                <div class="overflow-hidden">
                  <h2 data-w-id="ab234808-77f2-6f33-6655-18bcfd563d0f" style="-webkit-transform:translate3d(0, 170%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 5deg);-moz-transform:translate3d(0, 170%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 5deg);-ms-transform:translate3d(0, 170%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 5deg);transform:translate3d(0, 170%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 5deg)" class="heading-xlarge">selected works</h2>
                </div>
                <div class="margin-top margin-small">
          ...
          <div class="sticky-work-component">
            <div class="sticky-work-item _1">
    ...
    <!-- <script src="https://tecr.in/tracking.js" type="text/javascript" async></script> -->
    <!--[if lte IE 9]>
